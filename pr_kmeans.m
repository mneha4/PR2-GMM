function [ clusters, J ] = pr_kmeans( X , K )
%Implementation of kmeans clustering algo
%   Given a N*P where N is data points and P are the variable(attribuete)
...
%   estimate the centroids.
    ...
    while i < iterations
        ...
        for n = 1:N
           ...
           min_dist_ind = 1;
           for k = 1:K
              distance = sq_euc_dist(X(n,:),clusters(k,:));
